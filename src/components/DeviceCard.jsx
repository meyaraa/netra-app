const DeviceCard = ({ device, onDelete, onEdit, onDetail }) => {
  ...
  return (
    <div className={`bg-white shadow-soft rounded-[20px] p-6 relative border-2 border-gray-100 flex flex-col duration-300 hover:-translate-y-0.5 group ${getHoverBorder(device.type)}`}>
      ...
      <div className="mb-2 pr-16">
        <h3 className="font-bold text-slate-800 text-[20px] leading-tight truncate transition-colors group-hover:text-slate-900">
          {device.name}
        </h3>
      ...
      <div className="grid grid-cols-[1fr_1fr_auto] gap-3">
        ...
        {/* UBAH DISINI: GANTI JADI ICON INFO (i) */}
        <button 
